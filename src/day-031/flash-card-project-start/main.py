...
unknown_button = tk.Button(image=unknown_button_img, command=next_card, highlightthickness=0)
unknown_button.grid(row=1, column=0)

known_button_img = tk.PhotoImage(file="images/right.png")
known_button = tk.Button(image=known_button_img, command=is_known, highlightthickness=0)
